...
/**
 * Meta Instruction
 * HannyaShingyoクラスに、般若心経の核心部分である「呪文」を表現するメソッドを追加してください。
 * 
 * Instruction
 * 1. `mantra`という名前の新しいメソッドをHannyaShingyoクラスに追加する。
 * 2. このメソッドは、般若心経の呪文「羯諦羯諦　波羅羯諦　波羅僧羯諦　菩提　娑婆訶」を返すようにする。
 * 3. HannyaShingyoクラスのインスタンスを生成する。
 * 4. インスタンスのmantraメソッドを呼び出し、コンソールにその戻り値を出力する。
 */
...
console.log(`Mantra: ${hannyaShingyo.mantra}`);
